...
public class SaveDataManager
{
    ...
    public SaveDataManager()
    {
        ...
        cachedProgress = SaveManager.Instance.Load<GameProgress>("Progress") ?? new GameProgress();
    }
    ...
    public void SaveProgress(int chapterIndex, int episodeIndex, int storyIndex)
    {
        ...
        SaveManager.Instance.Save("Progress", cachedProgress);
    ...
    public void SaveStats(int[] statsArray)
    {
        ...
        SaveManager.Instance.Save("Stats", stats);
    }
    ...
    {
        if (SaveManager.Instance.Exists("Stats"))
        {
            return SaveManager.Instance.Load<PlayerStats>("Stats");
        }
        return null;
    }
    ...
    {
        return SaveManager.Instance.Exists(key);
    }
}
